...
export default function SignupScreen() {
  ...
  const handleSubmit = async () => {
    ...
    setSubmitting(true);
    try {
      await signIn({ email: trimmedEmail, name: name.trim() });
      router.replace('/');
    } finally {
      setSubmitting(false);
    }
    ...
    >
      ...
      >
        <View style={styles.brand}>
          ...
          <Text style={styles.tagline}>Join Pet Connect and meet nearby pets.</Text>
        </View>
...
const styles = StyleSheet.create({
  ...
  appName: { fontSize: 26, fontWeight: '800', color: colors.ink, textAlign: 'center' },
